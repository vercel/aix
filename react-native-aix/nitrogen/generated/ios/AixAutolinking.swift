...
public final class AixAutolinking {
  ...
  /**
   * Creates an instance of a Swift class that implements `HybridAixBlankViewSpec`,
   * and wraps it in a Swift class that can directly interop with C++ (`HybridAixBlankViewSpec_cxx`)
   *
   * This is generated by Nitrogen and will initialize the class specified
   * in the `"autolinking"` property of `nitro.json` (in this case, `HybridAixBlankView`).
   */
  public static func createAixBlankView() -> bridge.std__shared_ptr_HybridAixBlankViewSpec_ {
    let hybridObject = HybridAixBlankView()
    return { () -> bridge.std__shared_ptr_HybridAixBlankViewSpec_ in
      let __cxxWrapped = hybridObject.getCxxWrapper()
      return __cxxWrapped.getCxxPart()
    }()
  }
