...
/**
 * Wraps a Swift `(_ isNearEnd: Bool) -> Void` as a class.
 * This class can be used from C++, e.g. to wrap the Swift closure as a `std::function`.
 */
public final class Func_void_bool {
  public typealias bridge = margelo.nitro.aix.bridge.swift

  private let closure: (_ isNearEnd: Bool) -> Void

  public init(_ closure: @escaping (_ isNearEnd: Bool) -> Void) {
    self.closure = closure
  }

  @inline(__always)
  public func call(isNearEnd: Bool) -> Void {
    self.closure(isNearEnd)
  }
