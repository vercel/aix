...
const AixInternal = Animated.createAnimatedComponent(
  getHostComponent<AixProps, AixMethods>('Aix', () => AixConfig),
)
  ...
  return (
    <AixInternal
      ...
      onWillApplyContentInsets={
        props.onWillApplyContentInsets ? callback(props.onWillApplyContentInsets) : undefined
      }
      // Wrap onScrolledNearEndChange with callback() if provided
      onScrolledNearEndChange={
        props.onScrolledNearEndChange ? callback(props.onScrolledNearEndChange) : undefined
      }
