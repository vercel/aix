...
const AnimatedFadeInText = memo(function AnimatedFadeInText(props: { text: string }) {
...
export const TextFadeInStaggeredIfStreaming = memo(function TextFadeInStaggeredIfStreaming({
...
const TextFadeInStaggered = memo(function TextFadeInStaggered({ text }: { text: string }) {
