...
| `scrollToIndex`                   | `number`                       | -                                                                 | When set, triggers an animated scroll to this cell index. Use `-1` to indicate no scroll target. After the scroll completes, `onDidScrollToIndex` is called. Reset to `-1` after receiving the callback.                                                           |
