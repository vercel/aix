...
import com.margelo.nitro.aix.views.HybridAixCellViewStateUpdater

/**
 * Custom ViewGroupManager for AixCellView that supports children.
 * This replaces the generated HybridAixCellViewManager which extends SimpleViewManager.
 */
class AixCellViewManager : ViewGroupManager<ViewGroup>() {
