...
import com.margelo.nitro.aix.views.HybridAixStateUpdater

/**
 * Custom ViewGroupManager for Aix that supports children.
 * This replaces the generated HybridAixManager which extends SimpleViewManager.
 */
class AixViewManager : ViewGroupManager<ViewGroup>() {
